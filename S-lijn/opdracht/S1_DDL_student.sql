...
INSERT INTO afdelingen (anr, naam, locatie) VALUES (50 , 'IMPORT', 'DELFT');
INSERT INTO afdelingen (anr, naam, locatie) VALUES (60 , 'EXPORT', 'DELFT');
INSERT INTO afdelingen (anr, naam, locatie) VALUES (70 , 'SUPPORT', 'DELFT');
INSERT INTO afdelingen (anr, naam, locatie) VALUES (80 , 'MANAGEMENT', 'DELFT');
INSERT INTO afdelingen (anr, naam, locatie) VALUES (90 , 'HR', 'DELFT');
INSERT INTO afdelingen (anr, naam, locatie) VALUES (100 , 'CAFETARIA', 'DELFT');
...
(
    ...
    telefoon NUMERIC(10) CONSTRAINT a_telefoon_un UNIQUE ,
    med_mnr NUMERIC(4) CONSTRAINT a_med_fk REFERENCES medewerkers DEFERRABLE,
    PRIMARY KEY (postcode, huisnummer, ingangsdatum)
);

INSERT INTO adressen (postcode, huisnummer, ingangsdatum, einddatum, telefoon, med_mnr)  values ('2622BN', 3, '01-01-2021' , '02-01-2021', 0622731715, 7499 );
...
ALTER TABLE medewerkers ADD CONSTRAINT m_comm_chk CHECK ( CASE WHEN functie != 'VERKOPER' THEN comm IS NULL ELSE comm IS NOT NULL END ) ;
ALTER TABLE medewerkers DROP CONSTRAINT  m_comm_chk;
